...
export const DashboardCard: React.FC<DashboardCardProps> = ({
  ...
  return (
    <div className={`glass-card p-5 rounded-2xl border ${colorStyles[variantColor].split(' ')[0]} bg-gray-900/60 space-y-3 hover:border-purple-500/40 transition-all shadow-md`}>
