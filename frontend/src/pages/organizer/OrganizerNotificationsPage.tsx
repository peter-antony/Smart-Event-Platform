    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="glass-panel p-6 rounded-3xl border border-purple-500/30 bg-gradient-to-r from-purple-950/50 via-indigo-950/40 to-brand-950/50 flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-extrabold text-white tracking-tight">Organizer Notifications</h1>
          ...
          <p className="text-xs text-gray-400">System alerts, new ticket sales, inventory capacity warnings, and payouts</p>
        </div>
      ...
      <div className="space-y-3">
        {notifications.map((n) => (
          ...
          >
            <div className="p-2.5 rounded-xl bg-purple-600/30 text-purple-300 border border-purple-500/40 shrink-0">
              {n.type === 'BOOKING' ? (
